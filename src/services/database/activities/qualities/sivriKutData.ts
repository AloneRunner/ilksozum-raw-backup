...
export const sivriKutData: ConceptRound[] = [
    // Sivri Kalem (164) vs Küt Kalem (165)
    ...
    // Sivri Bıçak (262) vs Küt Kaşık (125)
    ...
    // Sivri Çatal (126) vs Küt Kaşık (125)
    ...
    // Sivri Yıldız (69) vs Küt Daire (65)
    ...
    // Sivri Kirpi (418) vs Küt Kaplumbağa (42)
    ...
    // Sivri Ok (634) vs Küt Uçlu Çubuk (592)
    ...
    // Sivri Çivi (525) vs Küt Vida Başı (53)
    ...
    // Sivri Diken (346) vs Küt Ağaç Dalı (536)
