...
export const cleanDirtyData: ConceptRound[] = [
    // 1. El
    { id: 1, question: "Temiz olan hangisi?", questionAudioKey: "q_which_is_clean_person", activityType: ActivityType.CleanDirty, options: [
    ...
    { id: 5, question: "Temiz olan hangisi?", questionAudioKey: "q_which_is_clean", activityType: ActivityType.CleanDirty, options: [
        { id: 82, word: "pencere", imageUrl: "/images/82.png", isCorrect: true, audioKey: "temiz_pencere", spokenText: "temiz pencere" }, // ID 596 -> 82 olarak düzeltildi
    ...
    { id: 6, question: "Kirli olan hangisi?", questionAudioKey: "q_which_is_dirty", activityType: ActivityType.CleanDirty, options: [
        { id: 82, word: "pencere", imageUrl: "/images/82.png", isCorrect: false, audioKey: "temiz_pencere", spokenText: "temiz pencere" }, // ID 596 -> 82 olarak düzeltildi
