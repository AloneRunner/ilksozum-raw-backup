...
export const kalabalikTenhaData: ConceptRound[] = [
    ...
    { id: 104, word: "ağaç", imageUrl: "/images/104.png", isCorrect: false, audioKey: "ağaç", spokenText: "tenha ağaç" } // normalized to 'tenha ağaç'
    ]},
    ...
    { id: 104, word: "ağaç", imageUrl: "/images/104.png", isCorrect: true, audioKey: "ağaç", spokenText: "tenha ağaç" } // normalized to 'tenha ağaç'
    ]},
    ...
    { id: 15, question: "Kalabalık olan hangisi?", questionAudioKey: "q_which_is_crowded", activityType: ActivityType.KalabalikTenha, options: [
        { id: 194, word: "okul otobüsü", imageUrl: "/images/194.png", isCorrect: true, audioKey: "okul_otobüsü", spokenText: "kalabalık otobüs" }, // Öğrenciler içinde
        { id: 105, word: "okul otobüsü", imageUrl: "/images/105.png", isCorrect: false, audioKey: "okul_otobüsü", spokenText: "tenha otobüs" } // Boş otobüs
    ]},
    { id: 16, question: "Tenha olan hangisi?", questionAudioKey: "q_which_is_sparse", activityType: ActivityType.KalabalikTenha, options: [
        { id: 194, word: "okul otobüsü", imageUrl: "/images/194.png", isCorrect: false, audioKey: "okul_otobüsü", spokenText: "kalabalık otobüs" },
        { id: 105, word: "okul otobüsü", imageUrl: "/images/105.png", isCorrect: true, audioKey: "okul_otobüsü", spokenText: "tenha otobüs" }
    ]},
];