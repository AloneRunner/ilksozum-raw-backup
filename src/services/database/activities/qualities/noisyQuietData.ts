...
export const noisyQuietData: ConceptRound[] = [
    ...
    { id: 1, question: "Gürültülü olan hangisi?", questionAudioKey: "q_which_is_noisy_person", activityType: ActivityType.NoisyQuiet, options: [
    ...
    // 9. Gitar vs Fırça
    { id: 17, question: "Gürültülü olan hangisi?", questionAudioKey: "q_which_is_noisy", activityType: ActivityType.NoisyQuiet, options: [
        { id: 180, word: "gitar", imageUrl: "/images/180.png", isCorrect: true, audioKey: "gitar", spokenText: "gürültülü gitar" },
        { id: 539, word: "fırça", imageUrl: "/images/539.png", isCorrect: false, audioKey: "fırça", spokenText: "sessiz fırça" }
    ]},
    { id: 18, question: "Sessiz olan hangisi?", questionAudioKey: "q_which_is_quiet", activityType: ActivityType.NoisyQuiet, options: [
        { id: 180, word: "gitar", imageUrl: "/images/180.png", isCorrect: false, audioKey: "gitar", spokenText: "gürültülü gitar" },
        { id: 539, word: "fırça", imageUrl: "/images/539.png", isCorrect: true, audioKey: "fırça", spokenText: "sessiz fırça" }
    ]},

    // 10. Düdük vs Pamuk
    { id: 19, question: "Gürültülü olan hangisi?", questionAudioKey: "q_which_is_noisy", activityType: ActivityType.NoisyQuiet, options: [
        { id: 427, word: "düdük", imageUrl: "/images/427.png", isCorrect: true, audioKey: "düdük", spokenText: "gürültülü düdük" },
        { id: 27, word: "pamuk", imageUrl: "/images/27.png", isCorrect: false, audioKey: "pamuk", spokenText: "sessiz pamuk" }
    ]},
    { id: 20, question: "Sessiz olan hangisi?", questionAudioKey: "q_which_is_quiet", activityType: ActivityType.NoisyQuiet, options: [
        { id: 427, word: "düdük", imageUrl: "/images/427.png", isCorrect: false, audioKey: "düdük", spokenText: "gürültülü düdük" },
        { id: 27, word: "pamuk", imageUrl: "/images/27.png", isCorrect: true, audioKey: "pamuk", spokenText: "sessiz pamuk" }
    ]},
];