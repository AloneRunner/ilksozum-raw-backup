...
export const hungryFullData: ConceptRound[] = [
    // 1. Kedi
    { id: 1, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
    ...
    { id: 2, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
    ...
    // 2. Sincap
    { id: 3, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
    ...
    { id: 4, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
    ...
    // 3. Bebek
    { id: 5, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
    ...
    { id: 6, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
    ...
    // 4. Canavar
    { id: 7, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
        { id: 755, word: "canavar", imageUrl: "/images/755.png", isCorrect: true, audioKey: "canavar_aç", spokenText: "aç canavar" },
        { id: 756, word: "canavar", imageUrl: "/images/756.png", isCorrect: false, audioKey: "canavar_tok", spokenText: "tok canavar" }
    ]},
    { id: 8, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
        { id: 755, word: "canavar", imageUrl: "/images/755.png", isCorrect: false, audioKey: "canavar_aç", spokenText: "aç canavar" }, // Farklı 'aç' görseli kullanılıyor
        { id: 756, word: "canavar", imageUrl: "/images/756.png", isCorrect: true, audioKey: "canavar_tok", spokenText: "tok canavar" }
    ]},

    // 5. Maymun
    { id: 9, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
    ...
    { id: 10, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
    ...
    // 6. Kuş
    { id: 11, question: "Aç olan hangisi?", questionAudioKey: "q_which_is_hungry_person", activityType: ActivityType.HungryFull, options: [
    ...
    { id: 12, question: "Tok olan hangisi?", questionAudioKey: "q_which_is_satiated_person", activityType: ActivityType.HungryFull, options: [
