...
export const aliveLifelessData: ConceptRound[] = [
    // 1. Ağaç vs Taş
    { id: 1, question: "Canlı olan hangisi?", questionAudioKey: "q_which_is_alive_person", activityType: ActivityType.AliveLifeless, options: [
    ...
    // 2. Kedi vs Masa
    { id: 3, question: "Canlı olan hangisi?", questionAudioKey: "q_which_is_alive_person", activityType: ActivityType.AliveLifeless, options: [
    ...
    { id: 21, question: "Canlı olan hangisi?", questionAudioKey: "q_which_is_alive", activityType: ActivityType.AliveLifeless, options: [
        { id: 866, word: "zebra", imageUrl: "/images/866.png", isCorrect: true, audioKey: "zebra", spokenText: "canlı zebra" },
        { id: 815, word: "tuvalet kağıdı", imageUrl: "/images/815.png", isCorrect: false, audioKey: "tuvalet_kağıdı", spokenText: "cansız tuvalet kağıdı" }
    ]},
    { id: 22, question: "Cansız olan hangisi?", questionAudioKey: "q_which_is_lifeless", activityType: ActivityType.AliveLifeless, options: [
        { id: 866, word: "zebra", imageUrl: "/images/866.png", isCorrect: false, audioKey: "zebra", spokenText: "canlı zebra" },
        { id: 815, word: "tuvalet kağıdı", imageUrl: "/images/815.png", isCorrect: true, audioKey: "tuvalet_kağıdı", spokenText: "cansız tuvalet kağıdı" }
    ]},

    // (Removed fruit/vegetable items: muz and patates — these were dynamic and are intentionally omitted)
    ...
    { id: 25, question: "Canlı olan hangisi?", questionAudioKey: "q_which_is_alive", activityType: ActivityType.AliveLifeless, options: [
        { id: 861, word: "hamster", imageUrl: "/images/861.png", isCorrect: true, audioKey: "hamster", spokenText: "canlı hamster" },
        { id: 162, word: "helikopter", imageUrl: "/images/162.png", isCorrect: false, audioKey: "helikopter", spokenText: "cansız helikopter" }
    ]},
    { id: 26, question: "Cansız olan hangisi?", questionAudioKey: "q_which_is_lifeless", activityType: ActivityType.AliveLifeless, options: [
        { id: 861, word: "hamster", imageUrl: "/images/861.png", isCorrect: false, audioKey: "hamster", spokenText: "canlı hamster" },
        { id: 162, word: "helikopter", imageUrl: "/images/162.png", isCorrect: true, audioKey: "helikopter", spokenText: "cansız helikopter" }
    ]},
];